...
const buttonVariants = cva(
  "cursor-pointer group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_18px_40px_-22px_rgba(214,119,61,0.95)] hover:-translate-y-0.5 hover:bg-primary/92 hover:shadow-[0_24px_45px_-20px_rgba(214,119,61,0.95)]",
        outline:
          "border-border/70 bg-background/80 text-foreground shadow-[0_14px_32px_-24px_rgba(15,23,42,0.45)] backdrop-blur-sm hover:-translate-y-0.5 hover:bg-accent/70 hover:text-foreground aria-expanded:bg-accent/70 aria-expanded:text-foreground dark:bg-background/50",
        secondary:
          "bg-secondary text-secondary-foreground shadow-[0_16px_36px_-26px_rgba(60,129,122,0.75)] hover:-translate-y-0.5 hover:bg-secondary/88 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
